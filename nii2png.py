...
import sys, getopt
directory=r"D:\Project Based\datasets\3DLSC-Covid\3DLSC-COVID\lesion segmentation\COVID-19"
def main(argv,file):
    inputfile = file
    outputfile = r'D:\Project Based\datasets\3DLSC-Covid\3DLSC-COVID\lesion segmentation\COVID-19\png'
    try:
    ...
    # else if 3D image inputted
        ...
        for current_slice in range(0, total_slices):
            ...
            if (slice_counter % 1) == 0:
                ...
                if (slice_counter % 1) == 0:
                    print('Saving image...')
                    if current_slice+1<=180 and current_slice+1>=50:
